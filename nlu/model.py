...
# Create a dataset
# Choose a level of tokenization: byte-level -> static vocab, handles out-vocabulary
...
# Create arrays one-hoting enconding  (number of example, seq length, vocab_size )
# Create arrays sparse one-hoting enconding  (number of example, seq length)
